        ...
        <div className="min-h-screen bg-so-bg text-so-text-body pb-24">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 space-y-10">
                ...
                <section>
                    ...
                    <div
                        className="so-card p-6 border-so-border bg-[#181818] flex flex-col md:flex-row md:items-center justify-between gap-6"
                    >
                        <div className="flex items-start gap-4">
                            {/* <div className="w-12 h-12 rounded-lg bg-[#222222] border border-so-border flex items-center justify-center shrink-0 text-white">
                            ...
                            <div>
                                ...
                                <p className="text-xs sm:text-sm text-so-text-muted mt-1 leading-relaxed max-w-2xl">
                                    Use this to quiz yourself on things we learned in class!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="shrink-0 self-start md:self-center">
                            <button
                                ...
                                className="so-btn-primary px-5 py-2.5 text-xs sm:text-sm font-semibold group flex items-center gap-2"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="so-card p-5 border-so-border flex flex-col justify-between">
                            <div>
                                ...
                                <p className="text-xs text-so-text-muted leading-relaxed mb-4">
                                    Covers modules 1 through 7. This is to prep for the code writing portion of the exam; for the rest, use the topic quizzer.
                                </p>
                            </div>
                        ...
                        <div className="so-card p-5 border-so-border flex flex-col justify-between">
                            <div>
                                ...
                                <p className="text-xs text-so-text-muted leading-relaxed mb-4">
                                    Covers all topics in ENGR 102. This is to prep for the code writing portion of the exam; use the topic quizzer for the rest of your studying.
                                </p>
                            </div>
