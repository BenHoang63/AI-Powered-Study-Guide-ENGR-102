  ...
  theme: {
    extend: {
      colors: {
        ...
        so: {
          ...
          accent: {
            ...
            dark: '#500000',
            subtle: 'rgba(80, 0, 0, 0.25)',
            border: 'rgba(140, 20, 20, 0.45)',
          },
          // Remapped to Aggie Crimson so no orange exists anywhere
          orange: {
            DEFAULT: '#cc3333',
            hover: '#b32424',
            light: '#fca5a5',
      ...
      boxShadow: {
        ...
        'so-maroon': '0 0 0 2px #141414, 0 0 0 4px #500000',
        'so-orange': '0 0 0 2px #141414, 0 0 0 4px #500000',
      },
    },
  },
  plugins: [],
